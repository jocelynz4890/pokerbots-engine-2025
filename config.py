...
PLAYER_1_NAME = "A"
PLAYER_1_PATH = "./vegas_bot"  # can change to ,/vegas_bot or ./test_bot
# NO TRAILING SLASHES ARE ALLOWED IN PATHS
PLAYER_2_NAME = "B"
PLAYER_2_PATH = "./test_bot" # "./vegas_bot"  # Change this to './player_chatbot' to interact with your own bot!
